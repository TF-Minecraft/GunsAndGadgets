...
mvn -B --no-transfer-progress org.apache.maven.plugins:maven-install-plugin:3.1.4:install-file \
    -Dfile="libs/MythicLib-dist-1.7.1-20260819.194904-107.jar" -DgroupId="local" -DartifactId="MythicLib" \
    -Dversion="1.7.1-tfmc-e89a612e566e" -Dpackaging=jar -DgeneratePom=true "$@"
